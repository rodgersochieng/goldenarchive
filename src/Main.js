...
//   const PlayerControlButton = ({ onClick, icon, isDarkMode, ariaLabel, isPrimary = false }) => (
//     <motion.button
...
//         ${isPrimary ? 'text-white shadow-lg' : ''}
//       `}
//     >
//       {icon}
//     </motion.button>
...
//   const PlayerActionButton = ({ onClick, icon, label, isDarkMode, isPrimary = false }) => (
//     <motion.button
